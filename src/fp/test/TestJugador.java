...
public class TestJugador {
	...
	public static void main(String[] args) {
		Jugador j1=new Jugador("Karim Benzema",89,89,66000000.0,350000.0,33,LocalDate.of(1987,12,19),185,81,new Club("Real Madrid CF",91701,100),"France","Right","Yes");
		j1.incorporaPosiciones("CF");
		j1.incorporaPosiciones("ST");
		System.out.println(j1.toString());
		Jugador j2=new Jugador("Eden Hazard",85,85,52000000.,240000.0,30,LocalDate.of(1991, 1, 7),175,74,new Club("Real Madrid CF",91701,100),"Belgium","Right","Yes");
